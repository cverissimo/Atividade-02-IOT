    ...
    public void onClick(View view) {
        if (myListener != null){
            if (view.getId() == R.id.btnPreto)
                myListener.onFragmentInteraction("Preto");
            else if(view.getId() == R.id.btnAzul)
                myListener.onFragmentInteraction("Azul");
            else if(view.getId() == R.id.btnVerde)
                myListener.onFragmentInteraction("Verde");
            else if(view.getId() == R.id.btnVermelho)
                myListener.onFragmentInteraction("Vermelho");
            else if(view.getId() == R.id.btnAmarelo)
                myListener.onFragmentInteraction("Amarelo");
        }
    }
}